 ...
 */
public class TwoPhaseSimpexTest extends TestCase {
	...
	public void solve() {
		...
		while(tps.iterate() == PrimalSimplex.CONTINUE) {
	...
	public void testTPS10() {
		...
		this.minimize = true;
		this.targetCoefficients = new double[] {4, 8, 8, 4, 10001, 10000};
		this.constraints = new Constraint[] {
				new Constraint(new double[] {1, 1, 0, 0, 0, 0}, PrimalSimplex.EQUAL_TO,     200),
				new Constraint(new double[] {0, 0, 1, 1, 0, 0}, PrimalSimplex.EQUAL_TO,     200),
				new Constraint(new double[] {1, 0, 1, 0, 0, 0}, PrimalSimplex.LESS_THAN,    400),
				new Constraint(new double[] {0, 1, 0, 1, 0, 0}, PrimalSimplex.LESS_THAN,    400),
				new Constraint(new double[] {-1, 0, -1, 0, 400, 0}, PrimalSimplex.GREATER_THAN,   0),
				new Constraint(new double[] {0, -1, 0, -1, 0, 400}, PrimalSimplex.GREATER_THAN,   0)
